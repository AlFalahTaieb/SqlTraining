...
--4. he query shown gives the number of routes that visit either London Road (149) or Craiglockhart (53). Run the query and notice the two services that link these stops have a count of 2. Add a HAVING clause to restrict the output to these two routes.
...
WHERE (stopa.name='Craiglockhart' AND stopb.name='London Road') AND (a.num=4 OR a.num=45)
